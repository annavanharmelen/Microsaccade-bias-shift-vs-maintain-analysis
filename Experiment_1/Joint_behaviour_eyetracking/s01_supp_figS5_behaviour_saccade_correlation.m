...
%   2. eyetracking/s03_GA_saccade_bias.m
...
if saveFigures
    print(fullfile(figure_path, "figS5_supl_behaviour_x_bias_E1"), "-dsvg")
    print(fullfile(figure_path, "figS5_supl_behaviour_x_bias_E1"), "-dpng")
end
